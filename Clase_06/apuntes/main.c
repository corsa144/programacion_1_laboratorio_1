...
int main()
{
    ...
    int reintentos=3;
    //char *pResultado;
    //strncpy(pResultado,array,maximo+1);
    char mensaje[]={'i','n','g','r','e','s','e',':'};
    char mensajeError[]={'E','R','R','O','R'};
   /*for(i=0;i < CANTIDAD_EMPLEADOS;i++)
    ...
    getString( array, mensaje, mensajeError,minimo, maximo,reintentos);
